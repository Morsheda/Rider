...
import 'package:tf_rider/pages/ap3.dart';
import 'package:tf_rider/pages/notifications.dart';
import 'package:tf_rider/pages/profile.dart';

class APtwo extends StatefulWidget {
  final data;
  APtwo({Key key, this.data}) : super(key: key);
  @override
  _APtwoState createState() => _APtwoState(this.data);
}

class _APtwoState extends State<APtwo> {
  var data;
  _APtwoState(this.data);
  @override
