...
import 'package:tf_rider/pages/ap4.dart';
import 'package:tf_rider/pages/notifications.dart';
import 'package:tf_rider/pages/profile.dart';

class APthree extends StatefulWidget {
  final data;
  APthree({Key key, this.data}) : super(key: key);
  @override
  _APthreeState createState() => _APthreeState(this.data);
}

class _APthreeState extends State<APthree> {
  var data;
  _APthreeState(this.data);
  @override
