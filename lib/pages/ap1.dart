...
import 'package:tf_rider/pages/ap2.dart';
import 'package:tf_rider/pages/notifications.dart';
import 'package:tf_rider/pages/profile.dart';

class APone extends StatefulWidget {
  final data;
  APone({Key key, this.data}) : super(key: key);
  @override
  _APoneState createState() => _APoneState(this.data);
}

class _APoneState extends State<APone> {
  var data;
  _APoneState(this.data);
  @override
